...
def write_flags(flag_fn, fasta_fn, xml_fn):
    flag_file=open(flag_fn,'w')
    flag_file.write("# i/o\n")
    flag_file.write("-in:file:fasta %s\n"%fasta_fn)
    flag_file.write("-nstruct 1\n")
    ...
    flag_file.write("-in:file:spanfile %s/target.span\n"%run_dir)
    ...
    flag_file.write("-score:weights input/stage3_rlx_membrane.wts\n")
...
def write_xml(fn, template_filenames):
    ...
    xml_file.write("        <ScoreFunction name=\"stage1\" weights=\"input/stage1_membrane.wts\" symmetric=\"0\">\n")
    xml_file.write("            <Reweight scoretype=\"atom_pair_constraint\" weight=\"2\"/>\n")
    xml_file.write("        </ScoreFunction>\n")
    xml_file.write("        <ScoreFunction name=\"stage2\" weights=\"input/stage2_membrane.wts\" symmetric=\"0\">\n")
    xml_file.write("            <Reweight scoretype=\"atom_pair_constraint\" weight=\"1\"/>\n")
    xml_file.write("        </ScoreFunction>\n")
    xml_file.write("        <ScoreFunction name=\"fullatom\" weights=\"input/stage3_rlx_membrane.wts\" symmetric=\"0\">\n")
    xml_file.write("            <Reweight scoretype=\"atom_pair_constraint\" weight=\"1\"/>\n")
    xml_file.write("        </ScoreFunction>\n")
    ...
    xml_file.write("        <ConstraintSetMover name=\"cst\" add_constraints=\"1\" cst_file=\"input/constraint_number\" />\n")
    xml_file.write("        <Hybridize name=\"hybridize\" stage1_scorefxn=\"stage1\" stage2_scorefxn=\"stage2\" fa_scorefxn=\"fullatom\" batch=\"1\" stage1_increase_cycles=\"1.0\" stage2_increase_cycles=\"1.0\" linmin_only=\"1\" realign_domains=\"0\" disulf_file=\"input/disulf.txt\" keep_pose_constraint=\"1\">\n")
    ...
    xml_file.write("        <FastRelax name=\"relax\" scorefxn=\"membrane\" repeats=\"1\" dualspace=\"1\" bondangle=\"1\"/>")
    xml_file.write("    </MOVERS>\n")
    xml_file.write("    <APPLY_TO_POSE>\n")
    xml_file.write("    </APPLY_TO_POSE>\n")
    xml_file.write("    <PROTOCOLS>\n")
    xml_file.write("        <Add mover=\"cst\"/>\n")
    xml_file.write("        <Add mover=\"hybridize\"/>\n")
    xml_file.write("        <Add mover=\"clearconstraints\"/>\n")
    xml_file.write("        <Add mover=\"cst\"/>\n")
    xml_file.write("        <Add mover=\"relax\"/>\n")
    xml_file.write("        <Add mover=\"clearconstraints\"/>\n")
    xml_file.write("    </PROTOCOLS>\n")
...
if __name__=="__main__":
    ...
    if (not os.path.exists("hybrid/hybridize0_C1.xml")):
        ...
        write_flags(flag_fn, fasta_fn, xml_fn)
